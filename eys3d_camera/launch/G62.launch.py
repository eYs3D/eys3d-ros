...
launch/video_modes/G62.yaml for the full mode catalog.
...
def generate_launch_description():
    args = [
        ...
        DeclareLaunchArgument('mode_id',           default_value='-1',
                              description='Mode index from launch/video_modes/G62.yaml; -1 = auto (signature default for the negotiated USB link).'),
